			...
			if (t2 != null) {
				if (o.isDirectory()) {
					if (PARENT_DIRECTORY_NAME.equals(o.getName())) {
						...
						v.setContentDescription(c.getResources().getString(R.string.accesibility_back_parent_folder));
					}
					else {
						t2.setText(R.string.file_chooser_directorio);
						icon.setImageDrawable(this.c.getResources().getDrawable(R.drawable.icon_folder));
						v.setContentDescription(c.getResources().getString(R.string.accesibility_open_folder));
					}
				} else {
					...
					v.setContentDescription(c.getResources().getString(R.string.accesibility_select_file));
				}
			}
		}
